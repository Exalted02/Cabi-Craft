...
<main class="content">
	<div class="container-fluid p-0">
        <h1 class="h3 mb-3"><strong>{{$id=='0' ? "Add new" : "Edit"}}</strong> Static</h1>
        <div class="card">
			<form id="cat_form" action="{{route('admin.static.manage_static_process')}}" enctype="multipart/form-data" method="post">
			@csrf
			<div class="card-body">
				...
				<div class="row add_cat mb-3">
					...
					<div class="col-lg-10">
						...
						@else
							<img src="{{ asset('admin-assets/images/static/' .$image) }}" height="100" lenght="100"><br/>
						<input type="file" name="image" class="form-control">
				...
				<div class="row add_cat_submit mt-3">
					...
					<div class="col-lg-10">
					<a href="{{ route('admin.add-static') }}"><button type="button" class="btn btn-danger">Cancel</button></a>
