...
<main class="content">
	<div class="container-fluid p-0">
        <h1 class="h3 mb-3"><strong>{{$id=='0' ? "Add new" : "Edit"}}</strong> Material Ply 18mm</h1>
        <div class="card">
			<form id="cat_form" action="{{route('admin.materialply18mm.manage_materialply18mm_process')}}" enctype="multipart/form-data" method="post">
			@csrf
			<div class="card-body">
				...
				<div class="row add_cat_submit mt-3">
					...
					<div class="col-lg-10">
						<a href="{{ route('admin.materialply18mm') }}"><button type="button" class="btn btn-danger">Cancel</button></a>
