			...
			<div class="card-body">
				...
				<div class="row add_cat mb-3">
					...
					<div class="col-lg-10">
						...
						@else
							<img src="{{ asset('admin-assets/images/legtype/' .$image) }}" height="100" lenght="100"><br/>
						<input type="file" name="image" class="form-control">
				...
				<div class="row add_cat_submit mt-3">
					...
					<div class="col-lg-10">
						<a href="{{ route('admin.legtype') }}"><button type="button" class="btn btn-danger">Cancel</button></a>
