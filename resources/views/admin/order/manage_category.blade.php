...
<main class="content">
	<div class="container-fluid p-0">
        <h1 class="h3 mb-3"><strong>{{$id=='0' ? "Add new" : "Edit"}}</strong> Category</h1>
        <div class="card">
			<form id="cat_form" action="{{route('admin.category.manage_category_process')}}" enctype="multipart/form-data" method="post">
			@csrf
			<div class="card-body">
				<div class="row add_cat mb-3">
					<div class="col-lg-2">
						<h5 class="card-title mb-2">Category Name<sup>*</sup></h5>
					</div>
					<div class="col-lg-10">
						@if ($id=='0')
						...
						@else
						<input type="text" name="name" value="{{$name}}" class="form-control" placeholder="Category Name">
				...
				<div class="row add_cat mb-3">
					...
					<div class="col-lg-10">
						...
						@else
							<img src="{{ asset('admin-assets/images/categories/' .$image) }}" height="100" lenght="100"><br/>
						<input type="file" name="image" class="form-control">
