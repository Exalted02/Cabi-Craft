...
<link href="{{ asset('public/admin-assets/css/invoice.css') }}" rel="stylesheet">        
<main class="content">
	<div class="container ">

      <form method="POST" class="needs-validation" novalidate   action="https://script.google.com/macros/s/{{ session()->get('appApiKey') }}/exec">
            ...
            <div class="card-body">
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<option value="1">With Materials</option>
						<option value="2">Only Job Work</option>
						</select>
					</div>
				</div>
			</div>
                    ...
                    <div class="col-md-8 col-12">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control"   
                                   ...
                                   id="cust_nm" required minlength="4"  >
                    ...
                    <div class="col-md-4 col-12">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="date" class="form-control" 
                                   placeholder="Inv. Date" name="inv_dt" id="inv_dt">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
			   ...
			   <input type="hidden" value="{{$username}}" name="username" id="username">
				<div style="overflow-x:auto;">
					...
					<table class="table table-bordered table-scrolled">
						...
						<tbody class="dataTableBody" id="TBody"></tbody>
						...
						<div class="col-md-5 col-12">
							...
							<div class="col-md-12 invoiceprice">
								<div class="row">
									...
									<div class="col-md-8">	 
										  <input type="text" class="form-control" disabled id="gst_val">
							...
							<div class="col-md-12 invoiceprice">
								<div class="row">
									...
									<div class="col-md-8">	 
										  <input type="text" class="form-control" disabled id="grand_total">
	...
	<!-- The Add data Modal -->
<div class="modal addModal" id="inputFormModal" tabindex="-1" aria-labelledby="inputFormModal Label" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" onClick="close_add()">&times;</button>
      </div>

      <!-- Modal body -->
      <div class="modal-body">
			<div class="row">
                <div class="col-md-6 mb-3" id="selectcategory">
					<label for="formGroupExampleInput" class="form-label">Category</label>
					<select style="height: 50px" id="categorySelect" class="form-control js-example-responsive categry category-image" placeholder="Category*"> 
						<option value="">Select Category</option>
					</select>
					<span id="categoryErr"></span>
				</div>
			
				<div class="col-md-6 mb-3" id="scategory">
				...
				<div class="col-md-6 mb-3">
					...
					<span id="lengthErr"></span>
				</div>
				<div class="col-md-6 mb-3">
					<label for="formGroupExampleInput" class="form-label">Deep</label>
					<input type="text" class="form-control" id="deep" placeholder="Deep">
					<span id="deepErr"></span>
				</div>
				<div class="col-md-6 mb-3">
				...
				<div class="col-md-6 mb-3" id="selectmaterial">
					<label for="formGroupExampleInput" class="form-label">Material</label>
				    <select id="materialSelect" class="form-control">
						<option value="">Select Material</option>
					</select>
					<span id="materialselectErr"></span>
				</div>
				<div class="col-md-6 mb-3" id="ccolor">
				    <label for="formGroupExampleInput" class="form-label">Cabinet Colour</label>
				    <select id="cabinetcolour" class="form-control">
						<option value="">Select cabinet</option>
					</select>
					<span id="cabinetcolourErr"></span>
				</div>
				<div class="col-md-6 mb-3" id="eside">
				  <label for="formGroupExampleInput" class="form-label">EXPO SIDE</label>
				    <select id="exposide" class="form-control">
						<option value="">Select Expo Side</option>
					</select>
					<span id="exposideErr"></span>
				</div>
				<div class="col-md-6 mb-3">
					<label for="formGroupExampleInput" class="form-label">EXPO Colour</label>
					<input type="text" class="form-control" id="expocolour" placeholder="EXPO Colour">
					<span id="expocolourErr"></span>
				</div>
				<div class="col-md-6 mb-3" id="smaterial">
				    <label for="formGroupExampleInput2" class="form-label">Shutter  Material</label>
				    <select id="shuttermaterial" class="form-control">
						<option value="">Select Shutter  Material</option>
					</select>
					<span id="shuttermaterialErr"></span>
				</div>
				<div class="col-md-6 mb-3">
					<label for="formGroupExampleInput" class="form-label">Shutter Colour</label>
					<input type="text" class="form-control" id="shuttercolour" placeholder="Shutter Colour">
					<span id="shuttercolourErr"></span>
				</div>
				<div class="col-md-6 mb-3" id="ltype">
						<label for="formGroupExampleInput2" class="form-label">Leg Type</label>
				    <select id="legtype" class="form-control">
						<option value="">Select Leg Type</option>
					</select>
					<span id="legtypeErr"></span>
				</div>
				<div class="col-md-6 mb-3">
					<label for="formGroupExampleInput" class="form-label">Skt Hight (mm)</label>
					<input type="text" class="form-control" id="sktheight" placeholder="Skt Hight (mm)">
					<span id="sktheightErr"></span>
				</div>
				<div class="col-md-6 mb-3" id="htype">
					<label for="formGroupExampleInput2" class="form-label">Handel Type</label>
				    <select id="handeltype" class="form-control">
						<option value="">Handel Type</option>
					</select>
					<span id="handeltypeErr"></span>
				</div>
			</div>
		</div>
	  ...
	  <input type="submit" name="submit" id="handleSubmit" class="btn btn-primary" value="SUBMIT" onclick="handleSubmit()"/>
	   <input type="submit" name="submit" id="handlesearchSubmit" class="btn btn-primary" value="SUBMIT" onclick="handleSearchSubmit()"/>
        <button type="button" class="btn btn-danger" data-dismiss="modal" onClick="close_add()">Close</button>
      </div>
      ...
      <div class="modal-body">
			<div class="row">
                ...
                <div class="col-md-6" id="eselectcategory">
				  <label for="formGroupExampleInput" class="form-label">Category</label>
				  <select id="editcategorySelect" class="form-control js-example-responsive" placeholder="Category*" style="width:100px;">
						<option value="">Select Category</option>
				  </select>
				...
				<div class="col-md-6" id="escategory">
					<label for="formGroupExampleInput" class="form-label">Sub Category</label>
					<select id="editsubcategorySelect" class="form-control" style="width:100px;">
						<option value="">Select Sub Category</option>
					</select>
				...
				<div class="col-md-6" id="ectype">
					<label for="formGroupExampleInput" class="form-label">Cabinet Type</label>
					<select id="editcabinetTypeSelect" class="form-control" style="width:130px;">
						<option value="">Select Cabinet Type</option>
					</select>
				...
				<div class="col-md-6">
				  <label for="formGroupExampleInput" class="form-label">Deep</label>
				  <input type="text" class="form-control" id="editdeep" placeholder="Deep">
				...
				<div class="col-md-6" id="eselectmaterial">
				  <label for="formGroupExampleInput" class="form-label">Material</label>
				    <select id="editmaterialSelect" class="form-control">
						<option value="">Select Material</option>
					</select>
				...
				<div class="col-md-6" id="eccolor">
				    <label for="formGroupExampleInput" class="form-label">Cabinet Colour</label>
				    <select id="editcabinetcolour" class="form-control">
						<option value="">Select cabinet</option>
					</select>
				...
				<div class="col-md-6" id="eeside">
				  <label for="formGroupExampleInput" class="form-label">EXPO SIDE</label>
				    <select id="editexposide" class="form-control">
						<option value="">Select Expo Side</option>
					</select>
				...
				<div class="col-md-6">
				  <label for="formGroupExampleInput" class="form-label">EXPO Colour</label>
				  <input type="text" class="form-control" id="editexpocolour" placeholder="EXPO Colour">
				  <span id="editexpocolourErr"></span>
				</div>
				<div class="col-md-6" id="esmaterial">
				    <label for="formGroupExampleInput2" class="form-label">Shutter  Material</label>
				    <select id="editshuttermaterial" class="form-control">
						<option value="">Select Shutter  Material</option>
					</select>
				...
				<div class="col-md-6">
				  <label for="formGroupExampleInput" class="form-label">Shutter Colour</label>
				  <input type="text" class="form-control" id="editshuttercolour" placeholder="Shutter Colour">
				  <span id="editshuttercolourErr"></span>
				</div>
				<div class="col-md-6" id="eltype">
				  <label for="formGroupExampleInput2" class="form-label">Leg Type</label>
				    <select id="editlegtype" class="form-control">
						<option value="">Select Leg Type</option>
					</select>
				...
				<div class="col-md-6">
				  <label for="formGroupExampleInput" class="form-label">Skt Hight (mm)</label>
				  <input type="text" class="form-control" id="editsktheight" placeholder="Skt Hight (mm)">
				  <span id="editsktheightErr"></span>
				</div>
				<div class="col-md-6" id="ehtype">
				  <label for="formGroupExampleInput2" class="form-label">Handel Type</label>
				    <select id="edithandeltype" class="form-control">
						<option value="">Handel Type</option>
					</select>
...
<script src="{{ asset('admin-assets/js/invoice.js') }}"></script>
...
<!------- for select2 ------->
  ...
  //--------- original-------------------------------------
	...
	function order_store()
	{
		...
		//alert(total_amount);alert(gstAmt);alert(grand_total);
		...
		$.ajax({
			...
			type: "POST",
			data: {cust_nm:cust_nm, addr:addr,inv_dt:inv_dt,city:city,state:state,zipcode:zipcode,username:username,total_amount:total_amount,discount_coupon:discount_code,gstAmt:gstAmt,grand_total:grand_total,excel_sl_no:excel_sl_no,inv_sl:inv_sl,order_type:order_type,storedData:storedData, _token: "{{ csrf_token() }}"},
			//dataType: 'json',
