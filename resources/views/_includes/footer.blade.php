	   ...
	   <div class="container">
		  <div class="row">
			 <div class="col-md-3  col-sm-6 col-xs-12">
				<!-- Info Widget -->
				<div class="widget">
				   <div class="logo text-center"> <img alt="" src="{{ url('images/logo.png') }}"> </div>
			  ...
			  <div class="search-block">
				 <div class="row">
					<div class="col-md-12 col-xs-12 col-sm-12 popular-search">
						<div class="modal-head-img-title d-flex">
							<div class="image">
								<div class="image-background" style="background-image: url('https://www.areagroup.ch/images/marcuspoiss/products/97/1715258307-20240509_143646.jpg');"></div>
								<img class="" alt="" src="images/posting/1.avif">
							</div>
							<div>
								<h3>Highlights of North Sikkim | FREE Visit to Bhim Nala Falls</h3>
