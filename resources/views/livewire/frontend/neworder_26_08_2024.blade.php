					  ...
					  <!-- Left Sidebar -->
						 ...
						 <div class="sidebar mr-5px">
								  ...
								  <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
										<div class="panel-body">
											...
											<div class="row">
														...
														<div class="col-md-6 col-xs-6 col-sm-6">
															<span class="label label-warning"><font wire:click="open_customise_form({{ $cartlist->id }})">Customize</font> <ul class="pull-right ">
							...
							<div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
									...
									<input type="hidden" value="{{$cart_id ?? ''}}" wire.model="cart_id">
									...
									<div class="panel-body">
											...
											<div class="form-group row">
												...
												<div class="col-sm-7">
													<input id="customize_skt_height" class="form-control" placeholder="100" type="text" value="{{$customize_skt_height ?  $customize_skt_height: ''}}" wire:model="customize_skt_height">
  ...
  Launch demo modal
	...
	document.addEventListener('livewire:load', function () {
		 ...
		 $('#toggle3').prop('checked', false);
			...
			$(document).on('change', '.customize_expo_name', function (e) {
                var data = $(this).val();
                if (data != '') {
					@this.set('customize_expo_name', data, true);
                }
            });
			$(document).on('change', '.customize_expo_colour', function (e) {
                var data = $(this).val();
                if (data != '') {
					@this.set('customize_expo_colour', data, true);
                }
            });
			$(document).on('change', '.customize_cabinet_material', function (e) {
                var data = $(this).val();
                if (data != '') {
