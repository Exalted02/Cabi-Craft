...
<main class="content">
	<div class="container-fluid p-0">
        ...
        <div class="card">
			<form id="cat_form" action="{{route('admin.subcategory.manage_subcategory_process')}}" enctype="multipart/form-data" method="post">
			@csrf
			<div class="card-body">
				<div class="row add_cat mb-3">
					<div class="col-lg-2">
						<h5 class="card-title mb-2">Select Category<sup>*</sup></h5>
					</div>
					<div class="col-lg-10">
						@if ($id=='0')
				...
				<div class="row add_cat mb-3">
					<div class="col-lg-2">
						<h5 class="card-title mb-2">Sub Category<sup>*</sup></h5>
					</div>
					<div class="col-lg-10">
						@if ($id=='0')
						...
						@else
						<input type="text" name="name" value="{{$name}}" class="form-control" placeholder="Sub Category Name">
