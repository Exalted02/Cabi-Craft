...
class Neworder extends Component
{
	...
	public function open_customise_form($cartId)
    {
        ...
        $this->customise_form = true;  // today comment
        $this->final_form_new = true;  // today comment
	...
	public function submitcostomizeOrderForm()
    {
		...
		$model->user_id				=	auth()->user()->id;
		$model->length				=	$this->customize_length;
		$model->breadth				=	$this->customize_width;
		$model->deep				=	$this->customize_deep;
