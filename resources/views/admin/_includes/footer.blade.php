<footer class="footer">
	...
	@endif
<!--Delete modal start-->
	@if (request()->routeIs('admin.staff','admin.couponcode','admin.order','admin.category','admin.subcategory','admin.cabinettype','admin.material', 'admin.cabinet', 'admin.stock-management','admin.expanse-tracker','admin.customer-list','admin.projecttype','admin.products','admin.static','admin.cms'))
	...
	@if (request()->routeIs('admin.staff','admin.couponcode','admin.order','admin.category','admin.subcategory','admin.cabinettype','admin.material', 'admin.cabinet','admin.projecttype','admin.products','admin.static','admin.cms'))
	...
	@if (request()->routeIs('admin.staff','admin.order','admin.category', 'admin.subcategory','admin.cabinettype', 'admin.material', 'admin.material','admin.projecttype','admin.products','admin.static','admin.cms'))
...
@if (request()->routeIs('admin.staff','admin.couponcode','admin.order','admin.user','admin.category','admin.subcategory','admin.cabinettype','admin.material','admin.cabinet','admin.exposide','admin.shutter-material','admin.legtype','admin.handletype','admin.expanse-tracker','admin.customer-list','admin.materialply6mm','admin.materialply18mm','admin.shuttermaterialply18mm','admin.projecttype','admin.products','admin.static','admin.cms'))
...
@if(request()->routeIs('admin.staff','admin.couponcode','admin.order','admin.user','admin.category','admin.subcategory','admin.cabinettype','admin.material','admin.exposide','admin.shutter-material','admin.legtype','admin.handletype','admin.cabinet','admin.materialply6mm','admin.materialply18mm','admin.shuttermaterialply18mm','admin.projecttype','admin.products','admin.static','admin.cms'))
...
<!--Status change modal end-->
	@if(request()->routeIs('admin.staff','admin.couponcode','admin.order','admin.user','admin.category','admin.subcategory','admin.cabinettype','admin.material','admin.cabinet','admin.shutter-material','admin.legtype','admin.handletype','admin.exposide','admin.materialply6mm','admin.materialply18mm','admin.shuttermaterialply18mm','admin.projecttype','admin.products','admin.static','admin.cms'))
...
@if(request()->routeIs('admin.stock-management','admin.customer-list','admin.payment-mode','admin.expanse-tracker','admin.expense-type','admin.bill-generate','admin.projecttype','admin.products','admin.static','admin.cms'))
...
<!--Multiple Delete stock-management modal start-->
	...
	@if (request()->routeIs('admin.stock-management','admin.customer-list','admin.payment-mode','admin.expense-type','admin.expanse-tracker','admin.bill-generate','admin.projecttype','admin.products','admin.static','admin.cms'))
...
@if(request()->routeIs('admin.staff','admin.couponcode','admin.order','admin.user','admin.category','admin.subcategory','admin.cabinettype','admin.material','admin.cabinet','admin.exposide','admin.legtype','admin.handletype','admin.shutter-material','admin.materialply6mm','admin.materialply18mm','admin.shuttermaterialply18mm','admin.customer-bill','admin.customer-list','admin.payment-mode','admin.expense-type','admin.expanse-tracker','admin.bill-generate','admin.projecttype','admin.products','admin.static','admin.cms'))
